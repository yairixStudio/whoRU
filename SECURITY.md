...
- Forging a system dialog: a window that whoRU accepts as a macOS permission dialog although it was not drawn by one of the platform’s own dialog processes.
